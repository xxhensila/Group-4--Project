<?php
session_start();
define("ADMINURL","http://localhost/cakemyday/admin-panel");
?>
    ...
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <ul class="navbar-nav side-nav" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL;?> /suppliers-admin/show-suppliers.php" style="margin-left: 20px;">Suppliers</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL;?> /feedbacks-admins/show-feedbacks.php" style="margin-left: 20px;">Feedbacks</a>
          </li>    
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL;?> /contacts/contact.php" style="margin-left: 20px;">Admin Inbox</a>
          </li>   
        </ul>
        <?php endif; ?>
