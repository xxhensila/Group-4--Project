        ...
        <div class="banner">
            <div class="jumbotron jumbotron-video text-center bg-dark mb-0 rounded-0">
                <!-- <video width="100%" preload="auto" loop autoplay muted>
                    <source src='assets/media/fontier.mp4' type='video/mp4' />
                    <source src='assets/media/explore.webm' type='video/webm' />
                </video> -->
            <!-- <div class="jumbotron jumbotron-bg text-center rounded-0" style="background-image: url('assets/img/bg-header.jpg');"> -->
                <!-- <div class="jumbotron jumbotron-bg text-center rounded-0" style="background-image: url('<?php echo APPURL; ?>/assets/img/cuts.gif');"> -->
                <source src='<?php echo APPURL; ?>/assets/media/indexvideo.mp4' type='video/mp4' />
                <div class="container">
                    <h1 class="pt-5">
                        Login Page
                    </h1>
