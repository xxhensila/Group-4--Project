...
session_start();
define("APPURL", "http://localhost/cakemyday");
...
require dirname(dirname(__FILE__)) . "/config/config.php";
    ...
    if(isset($_SESSION['user_id'])) {
        $cart = $conn->query("SELECT COUNT(*) as num_products FROM card WHERE user_id='$_SESSION[user_id]'");
        $cart->execute();
...
<html>
<head>
    <title>Cake My Day | Pastry Shop</title>
    <meta charset="utf-8">
        ...
        <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-transparent" id="page-navigation">
            <div class="container">
                ...
                <a href="<?php echo APPURL; ?>/index.php" class="navbar-brand">
                    <img src="<?php echo APPURL; ?>/assets/img/logo/logoindex.png" alt="">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarcollapse">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php else : ?>
                        <li class="nav-item">
                            <a href="<?php echo APPURL; ?>/feedback.php" class="nav-link">Feedback</a>
                        </li>
