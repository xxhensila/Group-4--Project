<footer>
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h5>About</h5>
                    <p>Find us and experience the best cakes and sweets! If you have any questions about our products, call us. We would love to hear from you!</p>
                </div>
                <div class="col-md-3">
                    <h5>Links</h5>
                    <ul>
                ...
                <h5>Contact</h5>
                     <ul>
                         <li>
                            <a href="tel:+620892738334"><i class="fa fa-phone"></i> +492433442977</a>
                        </li>
                        <li>
                            <a href="mailto:hello@domain.com"><i class="fa fa-envelope"></i> hello@cakemyday.com</a>
                         </li>
                     </ul>
                ...
                <div class="col-md-3">
                     ...
                     <ul class="mb-0">
                         ...
                         <li style="height: 200px">
                             <div class="mockup">
                                 <img src="<?php echo APPURL; ?>/assets/img/website_Logo.PNG">
                             </div>
                         </li>
                     </ul>
                </div>
        ...
        <p class="copyright">&copy; 2023 Cake My Day | Pastry Shop. All rights reserved.</p>
    </footer>
