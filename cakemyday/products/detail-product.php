...
<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $insert = $conn->prepare("INSERT INTO card (pro_id, pro_title, pro_image, pro_price,
    ...
    if(isset($_GET['id'])) {
       ...
       if(isset($_SESSION['user_id'])) {
            ...
            $validate = $conn->query("SELECT * FROM card WHERE pro_id='$id' AND user_id='$_SESSION[user_id]'");
            $validate->execute();
       }
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <p>
                                    ...
                                    <span class="price"><?php echo $product->price; ?>ALL</span>
                        ...
                        <form method="POST" id="form-data">
                            ...
                            <?php else: ?>
                                    ...
                                    <a href="../auth/login.php" style="color:white;">  Log in to buy this product or add it to cart </a>
                                    </div>
                            <?php endif; ?>
                        </form>
                    </div>
                                ...
                                <div class="card card-product">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-price">
                                            ...
                                            <span class="reguler"><?php echo $products ->price; ?>ALL</span>
                                        </div>
...
<?php require "../includes/footer_sp.php"; ?>
    <script>
            $(document).ready(function() {
                ...
                // there can be no 0 in the input field.. related to quantity of products
            ...
            // reload for the moment when we push items to basket
            function withRef() {
